var docsDirName = '/zh-cn';
var sidebarTxt = '- [关于余途](/README.md)\n';
var path = require('path');
var curPath = path.resolve(__dirname) + docsDirName;
var baseDirArr = [];
const os = require('os');
...
fs.writeFile(path.resolve(__dirname) + '/_sidebar.md', sidebarTxt, function (err) {
    if (err) {
        //console.error(err);
    }
});